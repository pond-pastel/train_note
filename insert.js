...
export function applyInsert(toast) {
    ...
    function applyDetailsInsert(id, group) {
        ...
        if(id !== "to") {
            timeBox.classList.add("time-insert-box");
            const timeTitle = document.createElement("span");
            timeTitle.classList.add("time-insert-title");
        ...
        if(id !== "to") {
            ...
            lineBox.classList.add("line-insert-box");
            const lineTitle = document.createElement("span");
            lineTitle.classList.add("line-insert-title");
            ...
            fareBox.classList.add("fare-box");
            const fareTitle = document.createElement("span");
            fareTitle.classList.add("fare-insert-title");
    ...
    for(let i = 0;i < insertData.transferList.length;i++) {
        ...
        transferTitle.classList.add("transfer-title");
        ...
        transferInput.classList.add("transfer-station-name");
